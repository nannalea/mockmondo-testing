...
class GetCitiesApiTest extends TestCase {
    ...
    //Assert flight id matches regex to only contain numbers and is 10 characters long
    ...
    //Assert departure_city matches regex to only contain letters and spaces, commas, periods - but not start or end with a spcae and is between 2 and 50 characters long
    ...
    // Assert to_city_name matches regex to only contain letters, spaces, commas, periods - but not start or end with a spcae and is between 2 and 50 characters long
    ...
    //Assert to_country_name matches regex to only contain letters and periods and commas, but not start or end with a spcae and is between 2 and 50 characters long
    ...
    //Assert from_country_name matches regex to only contain letters  but not start or end with a spcae and is between 2 and 50 characters long

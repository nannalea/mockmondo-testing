...

{
    ...
    protected function setUp(): void
    {
        ...
        $to_city_name = 'London';
        $this->results = $this->flightSearchResults->search($from_city_name, $to_city_name);
    }
    ...
    public function testSearchReturnsEmptyArrayWhenNoResultsFound()
    {
        ...
        $results = $this->flightSearchResults->search($from_city_name, $to_city_name);

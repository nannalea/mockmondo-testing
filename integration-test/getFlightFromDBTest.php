...
class getFlightFromDBTest extends TestCase {
    ...
    public function testDepartureCityHasCorrectFormat(): void
    {
        ...
        $this->assertMatchesRegularExpression("/^[a-zA-ZÆØÅæøå -áàíìéèóòúùý]{2,85}$/", $departureCity, "The departure_city value '{$departureCity}' does not match regex.");
    }
    ...
    public function testArrivalCityHasCorrectFormat(): void
    {
        ...
        $this->assertMatchesRegularExpression("/^[a-zA-ZÆØÅæøå -áàíìéèóòúùý]{2,85}$/", $arrivalCity, "The arrival_city value '{$arrivalCity}' does not match regex.");
    }
    ...
    public function testDepartureCountryHasCorrectFormat(): void
    {
        ...
        $this->assertMatchesRegularExpression("/^[a-zA-ZÆØÅæøå -áàíìéèóòúùý]{2,56}$/", $departureCountry, "The departure_country value '{$departureCountry}' does not match regex.");
    }
    ...
    public function testArrivalCountryHasCorrectFormat(): void
    {
        ...
        $this->assertMatchesRegularExpression("/^[a-zA-ZÆØÅæøå -áàíìéèóòúùý]{2,56}$/", $arrivalCountry, "The arrival_country value '{$arrivalCountry}' does not match regex.");
    }
    ...
    public function testDepartureAirportHasCorrectFormat(): void
    {
        ...
        $this->assertMatchesRegularExpression("/^[a-zA-ZÆØÅæøå -áàíìéèóòúùý]{2,100}$/", $departureAirport, "The departure_airport value '{$departureAirport}' does not match regex.");
    }
    ...
    public function testArrivalAirportHasCorrectFormat(): void
    {
        ...
        $this->assertMatchesRegularExpression("/^[a-zA-ZÆØÅæøå -áàíìéèóòúùý]{2,100}$/", $arrivalAirport, "The arrival_airport value '{$arrivalAirport}' does not match regex.");
    }
